    ...
    // Check if it's a new user visit (no cart items in session)
    if (empty($_SESSION['cart'])) {
        // Reset the $num_items_in_cart to 0 for a new user
        $num_items_in_cart = 0;
    } else {
                                ...
                                <div class="carousel-item active">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="banner_taital">
                                            ...
                                            <a href="bats.php"><button class="buy_bt">See More</button></a>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                ...
                                <div class="carousel-item">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="banner_taital">
                                            ...
                                            <a href="gloves.php"><button class="buy_bt">See More</button></a>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                ...
                <div class="collection_section_2">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <a href="bats.php"><button class="seemore_bt">See More</button></a>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="racing_shoes">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <a href="helmets.php"><button class="seemore">See More</button></a>
                        </div>
                    </div>
                </div>
            </div>
